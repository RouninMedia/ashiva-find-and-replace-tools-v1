...
if (isset($_GET['appView'])) {
  ...
  if (($_GET['appView'] === 'confirm-pages') && (!isset($_POST['editPagesNow']))) {

    $_GET['appView'] = 'search-pages';
  }


  if ($_GET['appView'] === 'search-pages') {
  ...
  if (($_GET['appView'] === 'edit-pages') && (isset($_POST['editPagesNow'])) && ($_POST['editPagesNow'] === 'true')) {
    ...
    $Pages_To_Edit = json_decode(rawurldecode($_POST['pagesTargeted']), TRUE);
    ...
    $Query_String = str_replace('edit-pages', 'confirm-updates', $_SERVER['QUERY_STRING']);

    header('HTTP/1.1 307 Temporary Redirect');
    header('Location: '.$Protocol.$Domain.$Path.'?'.$Query_String);
  }

  if ($_GET['appView'] === 'confirm-updates') {

    unset($_POST['editPagesNow']);

    $Pages_Targeted_Array = (isset($_POST['pagesTargeted'])) ? json_decode($_POST['pagesTargeted'], TRUE) : [];
    $Pages_Untargeted_Array = (isset($_POST['pagesUntargeted'])) ? json_decode($_POST['pagesUntargeted'], TRUE) : [];

    $Pages_Targeted = (isset($_POST['pagesTargeted'])) ? rawurlencode($_POST['pagesTargeted']) : '[]';
    $Pages_Untargeted = (isset($_POST['pagesUntargeted'])) ? rawurlencode($_POST['pagesUntargeted']) : '[]';
  }
}
...
$App_View = $_GET['appView'] ?? 'initialise';
$Find_Phrase = $_GET['findPhrase'] ?? '␀';
$Case_Sensitive = $_GET['caseSensitive'] ?? 'true';
$Replace_Phrase = $_GET['replacePhrase'] ?? '␀';
$Replace_Activated =  $_GET['replaceActivated'] ?? 'false';
...
$Pages_Found = $_GET['pagesFound'] ?? '␀';
$Pages_Targeted = $Pages_Targeted ?? '␀';
$Pages_Untargeted = $Pages_Untargeted ?? '␀';
...
.searching,
.listening,
.multiPageEditorForm[data-app-view="confirm-updates"] .pagesSearched,
.pagesTargeted,
.pagesUntargeted,
.multiPageEditorPagesTargeted,
...
.multiPageEditorForm[data-app-view="confirm-pages"] .multiPageEditorFieldset,
.multiPageEditorForm[data-app-view="confirm-updates"] .multiPageEditorFieldset {
  display: none;
}

.multiPageEditorForm[data-app-view="input-text"][data-replace-activated="true"] .multiPageEditorHeading.\--replace,
.multiPageEditorForm[data-app-view="search-pages"][data-replace-activated="true"] .multiPageEditorHeading.\--replace,
.multiPageEditorForm[data-app-view="input-text"][data-replace-activated="true"][data-replace-phrase="␀"] .multiPageEditorHeading.\--remove,
.multiPageEditorForm[data-app-view="search-pages"][data-replace-activated="true"][data-replace-phrase="␀"] .multiPageEditorHeading.\--remove,
.multiPageEditorForm[data-app-view="input-text"][data-replace-activated="false"] .multiPageEditorHeading.\--find,
.multiPageEditorForm[data-app-view="search-pages"][data-replace-activated="false"] .multiPageEditorHeading.\--find,
.multiPageEditorForm[data-app-view="search-pages"][data-pages-found="false"] .multiPageEditorNotFound,
.multiPageEditorForm[data-app-view="search-pages"][data-pages-found="true"] .pageList.\--toEdit,
.multiPageEditorForm[data-app-view="search-pages"][data-pages-found="true"][data-replace-activated="true"] .multiPageEditorButton.\--confirm,
.multiPageEditorForm[data-app-view="confirm-updates"] .pagesTargeted,
.multiPageEditorForm[data-app-view="confirm-updates"] .pagesUntargeted,
.multiPageEditorForm[data-app-view="confirm-pages"] .multiPageEditorListConfirmed.\--replace,
.multiPageEditorForm[data-app-view="confirm-pages"][data-replace-phrase="␀"] .multiPageEditorListConfirmed.\--remove,
.multiPageEditorForm[data-app-view="confirm-pages"] .pageList.\--toEdit,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase] .multiPageEditorPagesTargeted.\--replaced,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase="␀"] .multiPageEditorPagesTargeted.\--removed,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase] .multiPageEditorPagesUntargeted.\--replaced,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase="␀"] .multiPageEditorPagesUntargeted.\--removed {
  display: block;
}

.multiPageEditorForm[data-app-view="search-pages"][data-pages-found="true"][data-replace-activated="true"] .multiPageEditorButtonGroup.\--list,
.multiPageEditorForm[data-app-view^="confirm-"] .multiPageEditorButtonGroup.\--edit {
  display: flex;
  justify-content: center;
}

.multiPageEditorForm[data-app-view="input-text"] .listening,
.multiPageEditorForm[data-app-view="search-pages"] .searching,
...
.multiPageEditorForm[data-app-view="search-pages"][data-replace-activated="true"] .pageListCheckbox {
  display: inline;
}

.multiPageEditorForm[data-replace-activated="true"][data-replace-phrase="␀"] .multiPageEditorHeading.\--replace,
.multiPageEditorForm[data-app-view="confirm-pages"] .multiPageEditorHeading.\--replace,
.multiPageEditorForm[data-app-view="confirm-pages"][data-replace-phrase="␀"] .multiPageEditorHeading.\--remove,
.multiPageEditorForm[data-app-view="confirm-pages"][data-replace-phrase="␀"] .multiPageEditorListConfirmed.\--replace,
.multiPageEditorForm[data-app-view="confirm-pages"] .multiPageEditorButton.\--edit.\--reinitialise,
.multiPageEditorForm[data-app-view="confirm-updates"] .multiPageEditorButton.\--edit.\--back,
.multiPageEditorForm[data-app-view="confirm-updates"] .multiPageEditorButton.\--edit.\--editNow,
.multiPageEditorForm[data-app-view="confirm-pages"] .pagesTargeted,
.multiPageEditorForm[data-app-view="confirm-pages"] .multiPageEditorListConfirmed,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase="␀"] .multiPageEditorPagesTargeted.\--replaced,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase="␀"] .multiPageEditorPagesUntargeted.\--replaced,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase][data-pages-untargeted="%5B%5D"] .multiPageEditorPagesUntargeted.\--replaced,
.multiPageEditorForm[data-app-view="confirm-updates"][data-replace-phrase][data-pages-untargeted="%5B%5D"] .multiPageEditorPagesUntargeted.\--removed {
  display: none;
}
...
[data-app-view="input-text"] .multiPageEditorButton.\--search {
...
data-pages-targeted="'.$Pages_Targeted.'"
...
<section class="pagesTargeted">
<h2 class="multiPageEditorPagesTargeted --removed"><span class="multiPageEditorSlot --find">'.str_replace('␀', '🚫', $Find_Phrase).'</span> removed from these pages:</h2>
<h2 class="multiPageEditorPagesTargeted --replaced"><span class="multiPageEditorSlot --find">'.str_replace('␀', '🚫', $Find_Phrase).'</span> replaced with <span class="multiPageEditorSlot --replace">'.str_replace('␀', '🚫', $Replace_Phrase).'</span> on these pages:</h2>

<ol class="pageList --edited">
';

for ($i = 0; $i < count($Pages_Targeted_Array); $i++) {

  echo '<li class="pageListItem --edited">
  <a class="pageListLink --edited" href="'.$Pages_Targeted_Array[$i].'" target="_blank">'.$Pages_Targeted_Array[$i].'</a>
  </li>'."\n";
}
...
const parseQueryParameters = (queryParameters) => {
  ...
  if (queryParameters.get(\'appView\') === \'confirm-pages\') {
...
const editMultiplePages = () => {
  ...
  window.location.href = newQuery;  // <= THIS SHOULD PROBABLY BE PUSHSTATE, NO (?) - NO. BECAUSE PHP needs to run Get_Full_Page_List.
}
...
const confirmMultiplePages = () => {
  ...
  if (pagesSelected === false) {
    ...
    appState.appView = \'confirm-pages\';
    updateApp(appState);
  }
}
...
const returnToSearch = () => {
  ...
  appState.pagesTargeted = \'␀\';
  appState.pagesUntargeted = \'␀\';
  appState.appView = \'search-pages\';
  updateApp(appState);
}
...
const editPagesNow = () => {
  ...
  const pagesTargetedArray = [];
  const pagesUntargetedArray = [];
  ...
  for (let pageLink of pageLinks) {
    ...
    if (selectedPageLinks.indexOf(pageLink) > -1) {
      ...
      pagesTargetedArray.push(pageLink.textContent);
    }

    else {
    
      pagesUntargetedArray.push(pageLink.textContent);
    }
  }

  const pagesTargeted = JSON.stringify(pagesTargetedArray);
  const pagesUntargeted = JSON.stringify(pagesUntargetedArray);
  const editPagesNow = \'true\';

  const form = document.createElement(\'form\');
  const method = \'post\';
  const action = window.location.href.replace(\'confirm-pages\', \'edit-pages\');
  Object.assign(form, {method, action});

  const data = {pagesTargeted, pagesUntargeted, editPagesNow};
...
const reinitialise = () => {
  ...
  window.location.href = window.location.href.split(\'?\')[0]; // <= THIS SHOULD POSSIBLY BE PUSHSTATE (?)
}
